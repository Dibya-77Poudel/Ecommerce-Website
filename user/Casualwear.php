    ...
    .logo-image {
        ...
        <nav class="navbar">
            <ul>
                ...
                <li class="cart-icon">
                    <a href="#cart" class="nav-icon"><i class="fas fa-shopping-cart"></i> Cart</a>
...
<div class="container-fluid">
    <div class="col-md-12">
        ...
        <h1 class="text-warning font-monospace text-center my-3">CASUAL WEAR</h1>
