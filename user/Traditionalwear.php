...
<h1 class="text-warning font-monospace text-center my-3">Traditional Wear</h1>
...
<?php
        ...
        while ($row = mysqli_fetch_array($Record)) {
            ...
            if ($check_page === 'Traditional Wear') {
                ...
                echo "
                <div class='col-md-2' style='margin-left:80px; margin-bottom: 20px;'> <!-- Adjusted for 4 cards per row -->
                    <form action='Insertcart.php' method='POST'>
                        <div class='card m-auto' style='width: 255px; height: 380px;'> <!-- Reduced size -->
                        
                            <!-- Image container for uniform sizing -->
                            <div class='image-container' style='position: relative; height: 200px;'> <!-- Adjusted height -->
                            ...
                            <div class='card-body text-center'>
                                ...
                                <div id='productDetails{$row['id']}' style='font-size: 0.8rem; margin: 5px 10px 0; color: #555; line-height: 1.3; max-width: 220px; word-wrap: break-word; white-space: normal;'> <!-- Adjusted font size -->
                                ...
                                <div style='width: 70%; margin: auto; margin-top: 10px; text-align: left;'>
                                    ...
                                    <input type='number' name='PQuantity' min='1' max='20' placeholder='Quantity'  
                                        style='width: 100%; padding: 6px; font-size: 0.8rem; box-sizing: border-box; height: 25px; margin-bottom: 10px;' required> <!-- Adjusted font size -->
                        
                                    <!-- Size Select -->
                                    <select name='PSize' class='form-select' 
                                        style='width: 100%; padding: 6px; font-size: 0.8rem; box-sizing: border-box; height: 30px;' required> <!-- Adjusted font size -->
                                ...
                                <!-- Add to Cart Button -->
                                <input type='submit' name='addCart' class='btn btn-warning text-white fw-bold' style='width: 80%; font-size: 0.9rem;' value='Add To Cart'> <!-- Adjusted button size -->
                            </div>
                        </div>
                    </form>
                </div>
